...
extern syscall mutex_create(struct mutex_t *);
extern syscall mutex_lock(struct mutex_t *);
extern syscall mutex_unlock(struct mutex_t *);
extern syscall cond_init(struct cond_t *);
extern syscall cond_wait(struct cond_t *, struct mutex_t *);
extern syscall cond_signal(struct cond_t *);

/*
extern future_t* future_alloc(future_mode_t);
extern syscall future_free(future_t*);
extern syscall future_get(future_t*, int*);
extern syscall future_set(future_t*, int);
*/
